...
\title{Face Detection  And Recognition On Clusters}
...
To run our solution on the cloud, we plan to pack images into bundle files, inspired by \cite{sweeney2011hipi}.
