...
public class FaceDetection extends Configured implements Tool {
	...
	public static class Map extends Mapper<Text, Image, Text, Image> {
		...
		protected void setup(Context context) {
			...
			classifier = new CvHaarClassifierCascade(cvLoad("/mnt/var/lib/hadoop/mapred/taskTracker/archive/haarcascade_frontalface_alt.xml"));
			
			// Make sure the cascade is loaded
			if (classifier.isNull()) {
				classifier = new CvHaarClassifierCascade(cvLoad("haarcascade_frontalface_alt.xml"));
			}
			
			if (classifier.isNull()) {
				classifier = new CvHaarClassifierCascade(cvLoad(getClass().getResource("haarcascade_frontalface_alt.xml").getPath()));
			}
